...
export default function PsikologChangePasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!json.success) {
        ...
        setSuccess(true)
        setTimeout(() => router.push("/dashboard/psikolog"), 1500)
      }
    } catch {
  ...
  return (
    <div className="max-w-[480px] mx-auto px-4 pt-6 pb-16">
      <div className="border-b border-[#E0D0F0] pb-3 mb-6">
        ...
        <p className="text-[12px] text-[#999AAA] mt-0.5">Kalau ini pertama kali login, ganti kata sandi sementara dengan yang baru sekarang.</p>
      </div>
