...
type Props = {
  // Diisi kalau datang dari WA Undangan Psikotes (ADR-017) — akun shell yang OTP-nya sudah
  // dikirim otomatis saat itu, jadi langsung lompat ke step "otp" tanpa perlu isi nomor lagi.
  initialPhone?: string
}

export default function ForgotPasswordForm({ initialPhone }: Props) {
  const [step, setStep] = useState<Step>(initialPhone ? "otp" : "phone")
