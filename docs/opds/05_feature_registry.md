...
| Skrining Perkembangan (KPSP) | 🔄 | 2 | **Selesai dikoding Juli 2026, menunggu deploy.** Form per kelompok usia (Ya/Tidak + alat bantu visual sederhana), hasil & rekomendasi (khusus pelanggan, catat gratis), riwayat, kartu navigasi baru di profil anak. Hasil "Sebaiknya konsultasi" kini terhubung langsung ke alur booking Konsultasi Psikolog Anak (jembatan WA lama sudah diganti) |
| Konsultasi Psikolog Anak (add-on/sesi) | 🔄 | 2 | **Selesai dikoding Juli 2026, menunggu deploy.** Checkout otomatis via Mayar, harga lewat Pricing Config Panel (4 key: Junior/Mid/Senior/Pelanggan — hanya Mid & Pelanggan yang aktif dijual saat peluncuran). Booking pilih tanggal + Slot Konsultasi tetap (09:00/13:00/16:00), sistem assign otomatis ke psikolog Senior aktif sesuai kapasitas harian |
